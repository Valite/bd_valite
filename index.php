			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>Base de datos Peliculas<br>
								proyecto completo en <a href="https://github.com/Valite/bd_valite">GitHub</a>.</h1>
							</header>
							<section class="tiles">
								<article class="style1">
									...
									<a href="peliculas.php">
										...
										<div class="content">
											<p>Guarda en la base de datos las peliculas que has visto o quieras ver</p>
										</div>
									</a>
								</article>
